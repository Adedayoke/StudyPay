...
import BudgetAssistant from "@/components/ai/BudgetAssistant";
    ...
    <div className="min-h-screen bg-student-gradient">
            ...
            <>
              ...
              <div className="mb-8">
                <BudgetAssistant
                  ...
                  weeklyBudget={new BigNumber(1.5)} // Example weekly budget
                />
              </div>
            </>
          )}
      ...
      {showScanner && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-dark-bg-secondary overflow-y-auto rounded-lg p-6 max-h-[90vh] max-w-md w-full">
            <div className="flex justify-between items-center mb-4">
